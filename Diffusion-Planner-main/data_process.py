...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_workers', type=int, default=os.cpu_count(), help='number of workers for data processing; set 1 to disable multiprocessing')
    ...
    processor.work(scenarios, num_workers=args.num_workers)
